    ...
    <div class="page_demande">
        ...
        <form class="demande-form" method="POST" action="{{Route('demandes.update',$demande->id)}}">
            ...
            <div class="form-block-inline">
                ...
                @enderror  
                <div class="form-block">
                    <p>decret <span class="asterisc">*</span></p>
                    <input required value="{{old('decret',$demande->decret)}}" type="text" name="decret" placeholder="Numero du decret"/>
                    @error("decret")
                        <p class="text-error">{{$message}}</p>
                    @enderror  
                </div>  
            ...
            <div class="form-block">
                <p>destination <span class="asterisc">*</span></p>
