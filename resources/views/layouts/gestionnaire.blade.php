        ...
        <main class="w-full">
            <sidebar class="sidebar1 z-50 w-64 h-screen transition-transform -translate-x-full md:translate-x-0 dark:bg-[#222338] dark:shadow-none dark:border-r-4 border-slate-900">
                ...
                <div class="menu-items flex flex-col justify-start items-center mt-7 w-full px-2">
                    <a href="{{Route('gestionnaire.dashboard')}}" class="text-slate-600 hover:rounded-lg w-full py-4 px-4 cursor-pointer flex justify-start items-center space-x-2 transition hover:text-white hover:bg-blue-500 dark:text-white" title="dashboard">
                        <i class="text-center fa-solid fa-grip"></i>
                        <span class="menu-item">dashboard</span>
                       
                    </a>
                    
                    <a href="{{Route('listeDemandes.index')}}" id="demandes-index" class="hover:shadow-xl shadow-gray-400 text-slate-600 hover:rounded-lg w-full py-4 px-4 cursor-pointer flex justify-start items-center space-x-2 transition hover:text-white hover:bg-blue-500 dark:text-white" title="message">
